...
y_speed: -3,
type: "enemy", 
lock_direction: true, use_ai: true, ai: {type: "goblin", speed: 10, targets: ["player"]},lock_direction: true,skin: load_sprite_skin(textures_path + "fish.txt"), show_nametag: true,
...
create_sprite({
	...
	skin: load_sprite_skin(textures_path + "sans.txt"),
ai: {type: "goblin", speed: 20, targets: ["player"]},has_resistance : false,lock_direction: false});
...
x_pos : randint(100,500),
 ...
 type: "enemy",
 use_ai: true,
 ai: {type: "goblin", speed: 7, targets: ["player"]},has_resistance : true,lock_direction: false,skin: load_sprite_skin(textures_path + "goblin.txt"), show_nametag: true});
